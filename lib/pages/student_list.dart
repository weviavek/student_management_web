...
class StudentListState extends State<StudentList> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: listOfStudents.isNotEmpty
          ? Align(
              alignment: Alignment.topCenter,
              child: SingleChildScrollView(
                child: SizedBox(
                  width: MediaQuery.sizeOf(context).width>600? MediaQuery.sizeOf(context).width * 0.75: MediaQuery.sizeOf(context).width,
                  child: Card(
                      elevation: 4,
                        ...
                        builder: (context, value, child) => ListView.separated(
                          ...
                          itemBuilder: (context, index) {
                            Future<StudentData> getCurrentData() {
                              ...
                              return ref
                                  .child(
                                      'Students/${listOfStudents[index].key}')
                                  .get()
                                  .then((snapshot) {
                                              ...
                                              ? ListTile(
                                                  ...
                                                  trailing: IconButton(
                                                      onPressed: () {
                                                        ...
                                                        showDialog(
                                                            context: context,
                                                            builder: (context) => Dialogs.showDeleteAlert(
                                                                listOfStudents[
                                                                        index]
                                                                    .currentData!
                                                                    .studentID!,
